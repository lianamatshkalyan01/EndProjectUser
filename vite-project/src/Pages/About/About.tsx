...
Company has straight delivery from leading European and American manufacturers and has positioned itself as a reliable partner of companies such as "Les Laboratories Servier”, "Sanofi-Aventis”, "Abbott”, "Berlin-Chemie AG”, "Novartis Consumer”, "Bayer Consumer”, "Hoffman-La Roche”, "Nycomed Austria”, "Pfizer”, etc.
    </div>
    </div>
...
Since 2018, the 24-hour delivery service of Alfa-Pharm has been operating, which was the first online 24-hour pharmacy in Armenia. The delivery service currently works only for the customers living in Yerevan. Customers residing in regions can order from the Alfa-Pharm website or mobile application and receive their order from the nearest Alfa-Pharm pharmacy. The prices indicated for the products on the Alfa-Pharm website and mobile application are valid only for ordering online and may differ from the prices in the pharmacy chain.
