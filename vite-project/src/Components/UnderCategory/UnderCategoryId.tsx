...
const UnderCategoryId: React.FC = () => {
  ...
  return (
    <div style={{ backgroundColor: "#EDEDED", marginLeft: "10%", marginRight: "10%" }}>
      ...
      <Button onClick={handleFavoriteClick} style={{marginLeft:"14%" ,marginRight: '10px', fontSize: '20px', fontWeight: 'bolder', marginTop: '20px' }}>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', marginLeft: "50px", gap: "5px", marginTop: "5px", borderRadius: "10px", overflow: "hidden" }}>
          {filteredProducts.map((product, index) => (
            <div key={index} style={{ flex: '0 0 30.7%', margin: '10px', backgroundColor: "white", textDecoration: 'none' }}>
